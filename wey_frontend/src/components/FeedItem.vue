<template>
  ...
  <div class="my-6 flex justify-between">
    <div class="flex space-x-6">
      <div class="flex items-center space-x-2" @click="likePost(post.id)" style="cursor: pointer;">
      ...
      <div class="flex items-center space-x-2">
        ...
        <RouterLink :to="{ name: 'post', params: {id: post.id} }" class="text-gray-500 text-xs">0 comments</RouterLink>
      </div>
    </div>
